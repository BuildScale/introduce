...
// Introduce takes a set of environment and introduces it into the provided string using shell script expansions
func Introduce(env Env, str string) (string, error) {
	if env == nil {
		env = NewSliceEnv(nil)
	}
